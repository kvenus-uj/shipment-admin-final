...
export class ReturnsComponent implements OnInit {
  ...
  export()
  {
    var content = "STATUS\tORDER REFERENCE\tCUSTOMER\tRETURN TRACKING ID\tCREATION DATE\tORIGINAL TRACKING ID\tSENDER\n";
    this.getFilteredData.filter(a=>a.checked).forEach(function(row){
      content+=""+row.status+"\t"+row.orderReference+"\t"+row.customer+"\t"+row.trackingID+"\t"+row.creationDate+"\t"+row.originalTrackingID+"\t"+row.sender+"\n";
    });
