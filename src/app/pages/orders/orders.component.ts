...
export class OrdersComponent implements OnInit {
  ...
  export()
  {
    var content = "STATUS\tORDER REFERENCE\tTRACKING ID\tCUSTOMER\tCREATION DATE\tRECIPIENT\tCOUNTRY\tDELIVERY MODE\tOPTIONS\n";
    this.tableData.filter(a=>a.checked).forEach(function(row){
      content+=""+row.status+"\t"+row.orderReference+"\t"+row.trackingID+"\t"+row.customer+"\t"+row.creationDate+"\t"+row.recipient+"\n";
    });
